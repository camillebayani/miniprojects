...
function calculateTip() {
	...
	let tipAmnt = (amount * service) / persons;
    let billAmnt = amount / persons;


	//finally displaying the tip value
	document.querySelector('.totalea').style.display = 'block';
	document.getElementById('total').innerHTML = `₱ ${(billAmnt + tipAmnt).toFixed(2)}`;
}
